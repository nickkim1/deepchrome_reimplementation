...
# # -- parse in the arguments from parser class
...
# training_ds = parse_in()[0]
# valid_ds = parse_in()[1]
# testing_ds = parse_in()[2]
# output_dir = parse_in()[3]
# cell_type = parse_in()[4]
# hp_specs = parse_in()[5]
# model_path = parse_in()[6]
# n_e = parse_in()[7]
